...
.. note::
   ...
   この文書を書き始めたのはおそらく2013年頃であったかと思うが，それから10年以上が経過した2026年現在でも，Fortranは依然としていわゆるHigh-Performance Computing（HPC）では現役で用いられている言語であり続けている．

   しかし，もし筆者が独断と偏見で学生に教育する言語を選択するのであればFortranは選ばないであろう．各研究分野の都合にも大きく依存するであろうが，私見ではレガシーコードの維持という観点以外では，学生にFortranを教える積極な理由が見いだせてないためである．実際に新規開発される欧米のHPCコードやライブラリではC++，特にいわゆるModern C++を採用している例が多く見受けられるようになっている（その理由を考え始めると長くなるのでここでは述べない）．しかし，最近のC++はFortranに比べると非常に難しく，一般の研究者向きの言語とは呼べないシロモノになってしまっている．ここで救世主となろうとしているのがAIによるコード生成である．もはや人間が難解な文法やポインタ云々で悩まされることはなくなっているので，Fortranの時代は本格的に終わりを告げようとしているのかもしれない．
