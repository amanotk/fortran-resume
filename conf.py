...
html_title = "Fortran演習(地球惑星物理学演習)"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "Fortran演習"
...
latex_documents = [
    (master_doc, "fortran.tex", "Fortran演習", "天野孝伸", "manual"),
]
...
man_pages = [(master_doc, "fortran", "Fortran Documentation", [author], 1)]
